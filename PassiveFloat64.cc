...
// Implementation for PassiveFloat64.
//
// pwest 11/04/03
...
static char rcsid[] not_used = {"$Id: PassiveFloat64.cc,v 1.1 2004/07/09 16:34:38 pwest Exp $"};
...
{
    return new PassiveFloat64(*this);
}

PassiveFloat64::~PassiveFloat64()
{
    DBG(cerr << "~PassiveFloat64" << endl);
}
