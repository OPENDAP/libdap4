...
[
  ...
  if test $ac_cv_func_working_mktime = no; then
    dnl This definition breaks RHEL3 which requires that the symbol 'mktime'
    dnl be present. If it's not present gcc 3.2.3 complains that:
    dnl /usr/include/c++/3.2.3/ctime:72: `mktime' not declared
    dnl jhrg 7/8/05
