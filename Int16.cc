...
static char rcsid[] not_used = {"$Id: Int16.cc,v 1.20 2004/07/07 21:08:47 jimg Exp $"};
...
// $Log: Int16.cc,v $
// Revision 1.20  2004/07/07 21:08:47  jimg
// Merged with release-3-4-8FCS
//
// Revision 1.18.2.4  2004/07/02 20:41:52  jimg
