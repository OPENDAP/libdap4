...
class Dap4DatasetTest: public TestFixture {
    private:
	Dap4Dataset *dds1, *dds2;
    ...
    public:
        ...
        void setUp()
        {
            dds1 = new Dap4Dataset(&factory, "test1");
            dds2 = new Dap4Dataset(&factory, "test2");
        }
        ...
        CPPUNIT_TEST_SUITE( Dap4DatasetTest );
#if 1
...
\n\
    ...
    CPPUNIT_TEST_SUITE_REGISTRATION(Dap4DatasetTest);
