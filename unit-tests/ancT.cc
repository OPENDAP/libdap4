...
public:
    ...
    void find_ancillary_file_test() {
        ...
        CPPUNIT_ASSERT(Ancillary::find_ancillary_file((string)TEST_SRC_DIR + "/das-testste/test_1", "das",
                                                      (string)TEST_SRC_DIR + "/das-testsuite/",
                                                      "") == (string)TEST_SRC_DIR + "/das-testsuite/test_1.das");
        Ancillary::find_ancillary_file((string)TEST_SRC_DIR + "/das-testsuite/te1", "das",
                                       (string)TEST_SRC_DIR + "/das-testite/", "");
        CPPUNIT_ASSERT(Ancillary::find_ancillary_file((string)TEST_SRC_DIR + "/das-testsuite/te1", "das",
                                                      (string)TEST_SRC_DIR + "/das-testite/",
                                                      "") == (string)TEST_SRC_DIR + "/das-testsuite/das");
        CPPUNIT_ASSERT(Ancillary::find_ancillary_file((string)TEST_SRC_DIR + "/das-testste/test1", "das",
                                                      (string)TEST_SRC_DIR + "/das-testsuite/",
                                                      "") == (string)TEST_SRC_DIR + "/das-testsuite/das");
        CPPUNIT_ASSERT(Ancillary::find_ancillary_file((string)TEST_SRC_DIR + "/das-testste/test1", "das",
                                                      (string)TEST_SRC_DIR + "/das-testsuite/",
                                                      "test.1") == (string)TEST_SRC_DIR + "/das-testsuite/test.1.das");
        CPPUNIT_ASSERT(Ancillary::find_ancillary_file((string)TEST_SRC_DIR + "/das-testste/test1", "ds",
                                                      (string)TEST_SRC_DIR + "/das-testsuite/", "") == "");
    }
...
int main(int argc, char *argv[]) { return run_tests<ancT>(argc, argv) ? 0 : 1; }
