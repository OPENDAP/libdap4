...
public:
	...
	try
	{
	    ...
	    cout << " file byte" << endl ;
	    b.serialize( "somefile", eval, dds, fm, false ) ;
	    cout << " file int16" << endl ;
	    i16.serialize( "somefile", eval, dds, fm, false ) ;
	    cout << " file int32" << endl ;
	    i32.serialize( "somefile", eval, dds, fm, false ) ;
	    cout << " file uint16" << endl ;
	    ui16.serialize( "somefile", eval, dds, fm, false ) ;
	    cout << " file uint32" << endl ;
	    ui32.serialize( "somefile", eval, dds, fm, false ) ;
	    cout << " file float32" << endl ;
	    f32.serialize( "somefile", eval, dds, fm, false ) ;
	    cout << " file float64" << endl ;
	    f64.serialize( "somefile", eval, dds, fm, false ) ;
	    cout << " file str" << endl ;
	    str.serialize( "somefile", eval, dds, fm, false ) ;
	    cout << " file url" << endl ;
	    url.serialize( "somefile", eval, dds, fm, false ) ;
	    cout << " file structure" << endl ;
	    s.serialize( "somefile", eval, dds, fm, false ) ;
	    cout << " file array" << endl ;
	    arr.serialize( "somefile", eval, dds, fm, false ) ;
	    ...
	    seq.serialize( "somefile", eval, dds, fm, false ) ;
	...
	try
	{
	    ...
	    b.serialize( "somefile", eval, dds, sm, false ) ;
	    cout << " stream int16" << endl ;
	    i16.serialize( "somefile", eval, dds, sm, false ) ;
	    cout << " stream int32" << endl ;
	    i32.serialize( "somefile", eval, dds, sm, false ) ;
	    cout << " stream uint16" << endl ;
	    ui16.serialize( "somefile", eval, dds, sm, false ) ;
	    cout << " stream uint32" << endl ;
	    ui32.serialize( "somefile", eval, dds, sm, false ) ;
	    cout << " stream float32" << endl ;
	    f32.serialize( "somefile", eval, dds, sm, false ) ;
	    cout << " stream float64" << endl ;
	    f64.serialize( "somefile", eval, dds, sm, false ) ;
	    cout << " stream str" << endl ;
	    str.serialize( "somefile", eval, dds, sm, false ) ;
	    cout << " stream url" << endl ;
	    url.serialize( "somefile", eval, dds, sm, false ) ;
	    cout << " stream structure" << endl ;
	    s.serialize( "somefile", eval, dds, sm, false ) ;
	    cout << " stream array" << endl ;
	    arr.serialize( "somefile", eval, dds, sm, false ) ;
	    ...
	    seq.set_send_p( true ) ;
	    seq.set_leaf_sequence() ;
	    seq.serialize( "somefile", eval, dds, sm, false ) ;
