...
public:
    ...
    void cons_test() {
        CPPUNIT_ASSERT(tb5->value() == 0 && tb5->dataset() == "b" && tb5->name() == "a" && tb5->type() == dods_byte_c);
    ...
    void basetype_FQN_test() { CPPUNIT_ASSERT(tb1->FQN() == "tb1"); }
...
int main(int argc, char *argv[]) { return run_tests<ByteTest>(argc, argv) ? 0 : 1; }
