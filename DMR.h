...
private:
    ...
    bool compute_dap4_checksums = false;
...
public:
    ...
    bool compute_checksums() const { return compute_dap4_checksums; }
    void compute_checksums(bool checksum_value) { compute_dap4_checksums = checksum_value; }
};
