...
static char rcsid[] not_used = {"$Id: Error.tab.c,v 1.32 2003/12/08 18:02:29 edavis Exp $"};
...
static const short yyprhs[] = {     0,
     0,     6,     9,    11,    14,    16,    19,    24,    25,    31,
    36,    37
};

static const short yyrhs[] = {     5,
    10,    15,    11,    12,     0,    16,    17,     0,    16,     0,
    18,    19,     0,    18,     0,    21,    22,     0,     6,    13,
     3,    12,     0,     0,     8,    13,     4,    20,    12,     0,
     7,    13,     3,    12,     0,     0,     9,    13,     4,    23,
    12,     0
};
...
static const short yyrline[] = { 0,
   103,   106,   107,   110,   111,   114,   117,   124,   130,   132,
   139,   146
};
#endif
...
"SCAN_STR","SCAN_ERROR","SCAN_CODE","SCAN_PTYPE","SCAN_MSG","SCAN_PROGRAM","'{'",
"'}'","';'","'='","error_object","contents","description","program","code","message",
"@1","program_type","program_code","@2", NULL
};
#endif

static const short yyr1[] = {     0,
    14,    15,    15,    16,    16,    17,    18,    20,    19,    21,
    23,    22
};
...
static const short yydefact[] = {     0,
     0,     0,     0,     0,     3,     5,     0,     0,     0,     2,
     0,     0,     4,     0,     1,     0,     0,     6,     0,     7,
     0,     0,     8,    10,    11,     0,     0,     9,    12,     0,
     0,     0
};

static const short yydefgoto[] = {    30,
     4,     5,    10,     6,    13,    26,    11,    18,    27
};

static const short yypact[] = {    -5,
    -9,    -4,   -10,    -7,    -2,    -1,     3,    -3,     0,-32768,
     1,     2,-32768,     4,-32768,     5,     6,-32768,     7,-32768,
     8,    10,-32768,-32768,-32768,     9,    11,-32768,-32768,    12,
    17,-32768
};
...
static const short yytable[] = {     1,
     2,     3,     7,     8,     9,    14,    12,    21,    15,    17,
    23,    31,    16,    25,    19,    20,    32,     0,    22,    24,
    28,     0,    29
};

static const short yycheck[] = {     5,
    10,     6,    13,    11,     7,     3,     8,     3,    12,     9,
     4,     0,    13,     4,    13,    12,     0,    -1,    13,    12,
    12,    -1,    12
};
...
//
// Revision 1.31.2.2  2003/06/06 08:28:28  reza
