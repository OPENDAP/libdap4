...
/**
    The ArrayIterAdpater class is a specific IteratorAdapter for the Array
    class that represents the stl iterator used for the Array vector of
    dimensions. This class adapts the GNU Pix to stl iterators.

    @brief stl adapter class specific to the Array class
    @see IteratorAdapter
    @see AttrIterAdapter
    @see BTIterAdapter
...
class ArrayIterAdapter : public IteratorAdapter
{
	...
	/** Constructor which takes the Array vector and maintains an
	    iterator over that vector

	    @param vec Array vector to iterate over
	*/
