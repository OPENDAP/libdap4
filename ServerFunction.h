...
public:
    ...
    /**
     * If you are writing a function that can only operate on a particular kind of data, or one that relies on the
     * presence of particular metadata, then you might override this method in order to stop the server from advertising
     * the function in conjunction with datasets to which it cannot be applied.
     *
