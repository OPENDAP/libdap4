...
void TestGrid::_duplicate(const TestGrid &ts) { d_series_values = ts.d_series_values; }

BaseType *TestGrid::ptr_duplicate() { return new TestGrid(*this); }

TestGrid::TestGrid(const TestGrid &rhs) : Grid(rhs), TestCommon(rhs) { _duplicate(rhs); }

void TestGrid::output_values(std::ostream &out) {
...
TestGrid::TestGrid(const string &n, const string &d) : Grid(n, d), d_series_values(false) {}
...
void TestGrid::set_series_values(bool sv) {
