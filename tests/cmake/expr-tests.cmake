...
expr_test(61 "-w" "test.5" "g[1:4:9]" "test.5e" "xfail")
expr_test(62 "-W" "test.5" "g[1:4:9]" "test.5e" "xfail")
expr_test(63 "-w" "test.6" "i[1:4:9]" "test.6c" "xfail")
expr_test(64 "-W" "test.6" "i[1:4:9]" "test.6c" "xfail")
...
# build. 7/1625 jhrg
expr_test(73 "-bw" "test.a" "" "test.a" "pass")
expr_test(74 "-bW" "test.a" "" "test.a" "pass")
expr_test(75 "-bw" "test.a" "&i<2000" "test.aa" "pass")
expr_test(76 "-bW" "test.a" "&i<2000" "test.aa" "pass")
expr_test(77 "-bw" "test.a" "j&i>2000" "test.ab" "pass")
expr_test(78 "-bW" "test.a" "j&i>2000" "test.ab" "pass")
expr_test(79 "-bw" "test.a" "i,j&i<0" "test.ac" "pass")
expr_test(80 "-bW" "test.a" "i,j&i<0" "test.ac" "pass")
# Added 2/3/22 jhrg
expr_test(81 "-bw" "test.a" "s[0:3]" "test.ad" "pass")
expr_test(82 "-bW" "test.a" "s[0:3]" "test.ad" "pass")
expr_test(83 "-bw" "test.b" "" "test.b" "pass")
expr_test(84 "-bW" "test.b" "" "test.b" "pass")
expr_test(85 "-bw" "test.b" "i,f" "test.ba" "pass")
expr_test(86 "-bW" "test.b" "i,f" "test.ba" "pass")
expr_test(87 "-bw" "test.b" "i,f&i<2000" "test.bb" "pass")
expr_test(88 "-bW" "test.b" "i,f&i<2000" "test.bb" "pass")
expr_test(89 "-bw" "test.b" "i,f&f<0" "test.bc" "pass")
expr_test(90 "-bW" "test.b" "i,f&f<0" "test.bc" "pass")
expr_test(91 "-bw" "test.b" "i,j&i<2000" "test.bd" "pass")
expr_test(92 "-bW" "test.b" "i,j&i<2000" "test.bd" "pass")
expr_test(93 "-bw" "test.b" "&i<0" "test.be" "pass")
expr_test(94 "-bW" "test.b" "&i<0" "test.be" "pass")
expr_test(95 "-bw" "test.d" "" "test.d" "pass")
expr_test(96 "-bW" "test.d" "" "test.d" "pass")
expr_test(97 "-bw" "test.d" "i,f,a" "test.da" "pass")
expr_test(98 "-bW" "test.d" "i,f,a" "test.da" "pass")
expr_test(99 "-bw" "test.d" "i,f,a&i<2000" "test.db" "pass")
expr_test(100 "-bW" "test.d" "i,f,a&i<2000" "test.db" "pass")
expr_test(101 "-bw" "test.d" "i,f,a&f<0" "test.dc" "pass")
expr_test(102 "-bW" "test.d" "i,f,a&f<0" "test.dc" "pass")
expr_test(103 "-bw" "test.d" "i,f,a&a<10" "test.dd" "pass")
expr_test(104 "-bW" "test.d" "i,f,a&a<10" "test.dd" "pass")
expr_test(105 "-bw" "test.d" "i,f&i<2000" "test.de" "pass")
expr_test(106 "-bW" "test.d" "i,f&i<2000" "test.de" "pass")
expr_test(107 "-bw" "test.d" "i&i<2000" "test.df" "pass")
