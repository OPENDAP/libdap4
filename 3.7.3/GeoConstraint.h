...
public:
    ...
    Array::Dim_iter get_lon_dim() const {return d_lon_dim;}
    Array::Dim_iter get_lat_dim() const {return d_lat_dim;}
    void set_lon_dim(Array::Dim_iter lon) {d_lon_dim = lon;}
    void set_lat_dim(Array::Dim_iter lat) {d_lat_dim = lat;}
