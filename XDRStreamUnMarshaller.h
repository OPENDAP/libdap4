...
public:
    /**
     * @brief Builds an XDR unmarshaller that reads from a C++ stream.
    ...
    /**
     * @brief Deserialize vector elements using explicit DAP type information.
     * @param val Destination pointer for vector data.
     * @param num Number of elements decoded.
     * @param width Bytes per element.
     * @param type DAP type of each element.
     */
