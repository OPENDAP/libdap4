...
#define mb_cmp(mbc1, mbc2)                                                                                             \
    ((mbc1).wc_valid ? ((mbc2).wc_valid ? (int)(mbc1).wc - (int)(mbc2).wc : -1)                                        \
                     : ((mbc2).wc_valid                ? 1                                                             \
                        : (mbc1).bytes == (mbc2).bytes ? memcmp((mbc1).ptr, (mbc2).ptr, (mbc1).bytes)                  \
                        : (mbc1).bytes < (mbc2).bytes  ? (memcmp((mbc1).ptr, (mbc2).ptr, (mbc1).bytes) > 0 ? 1 : -1)   \
                                                       : (memcmp((mbc1).ptr, (mbc2).ptr, (mbc2).bytes) >= 0 ? 1 : -1)))
#define mb_casecmp(mbc1, mbc2)                                                                                         \
    ((mbc1).wc_valid ? ((mbc2).wc_valid ? (int)towlower((mbc1).wc) - (int)towlower((mbc2).wc) : -1)                    \
                     : ((mbc2).wc_valid                ? 1                                                             \
                        : (mbc1).bytes == (mbc2).bytes ? memcmp((mbc1).ptr, (mbc2).ptr, (mbc1).bytes)                  \
                        : (mbc1).bytes < (mbc2).bytes  ? (memcmp((mbc1).ptr, (mbc2).ptr, (mbc1).bytes) > 0 ? 1 : -1)   \
                                                       : (memcmp((mbc1).ptr, (mbc2).ptr, (mbc2).bytes) >= 0 ? 1 : -1)))
...
#define mb_setascii(mbc, sc)                                                                                           \
    ((mbc)->ptr = (mbc)->buf, (mbc)->bytes = 1, (mbc)->wc_valid = 1, (mbc)->wc = (mbc)->buf[0] = (sc))
...
static inline bool is_basic(char c) { return (is_basic_table[(unsigned char)c >> 5] >> ((unsigned char)c & 31)) & 1; }
