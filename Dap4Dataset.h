...
#ifndef _dap4_dataset_h
#define _dap4_dataset_h 1
...
class Dap4Dataset : public DapObj
{
private:
...
protected:
    void duplicate(const Dap4Dataset &dds);
...
public:
    ...
    Dap4Dataset(BaseTypeFactory *factory, const string &n = "");
    Dap4Dataset(const Dap4Dataset &dds);
