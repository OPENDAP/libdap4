...
public:
    ...
    /**
     * @brief Copy-constructs from another 16-bit signed integer variable.
     *
    ...
    /**
     * @brief Assigns from another 16-bit signed integer variable.
     *
    ...
    unsigned int width(bool = false) const override { return sizeof(dods_int16); }
     ...
     */
    int64_t width_ll(bool constrained = false) const override { return sizeof(dods_int16); }
     ...
     *
     * @return Stored signed 16-bit value.
     */
    virtual dods_int16 value() const;
    /**
     * @brief Sets the current value.
     *
     * @param val New signed 16-bit value.
